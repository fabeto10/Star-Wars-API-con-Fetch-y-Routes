...
export const CardSinglePeople = (props) =>{
    ...
    <div className="card mb-3">
        ...
        <div className="card-body">
            ...
            {props.hair_color && <p className="card-text">{`Hair Color: ${props.hair_color}-Skin Color: ${props.skin_color}-Eye Color: ${props.eye_color}-Birth Year: ${props.birth_year}`}</p>}
        </div>
    </div>
    )
}
